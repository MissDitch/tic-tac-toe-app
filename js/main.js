...
function AI(id, name, icon) {
          ...
          //  console.log(depth );
           // console.log(newState);
            ...
            if (player.name === "Computer") {
                var result = minMax(newState, depth, game.playerOne, moves);
             //   console.log("result human: ")
               // console.log(result);
                move.score = result.score;
           //     console.log(move.score);
            } else {
                var result = minMax(newState, depth, game.playerTwo, moves);
  ...
  //      }
    ...
    takeFirstMove = function() {
       //  console.log("computer taking first move");
        var matrix = game.board.getMatrix();
        matrix[4] = self.icon;
    ...
    takeSecondMove = function() {
        // console.log("computer taking second move");
        var matrix = game.board.getMatrix();
    ...
    takeNextMove = function() {
        ...
        var bestMove = minMax(origState, depth, aiPlayer, moves).index;
